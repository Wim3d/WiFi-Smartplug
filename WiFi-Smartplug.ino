/*
  ...
  Suitable for Sonoffs, BSD33, Sinilink, BSD34, NeoCoolcam
...
// base values
const char* software_version = "version 25";
const char* devicename = "sonoff1"; // 7 characters, then the length of the MQTT topic fits nicely
